<div class="app-header header sticky" style="margin-bottom: -74px;">
    <div class="container-fluid main-container">
        <div class="d-flex"> <a aria-label="Hide Sidebar" class="app-sidebar__toggle"
                ...
                class="logo-horizontal " href="{{route('dashboard.index')}}"> <img src="{{asset('assets/images/logo.jpeg')}}"
                    class="header-brand-img desktop-logo" alt="logo"> <img
                    src="{{asset('assets/images/logo.jpeg')}}" height="50" class="header-brand-img light-logo1"
                    alt="logo"> </a> <!-- LOGO -->
