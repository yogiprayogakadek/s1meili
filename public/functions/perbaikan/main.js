...
$(document).ready(function () {
        ...
        if (row.child.isShown()) {
            ...
            var row_div = '<div class="row">' +
                ...
                '<table class="table table-stripped table-hover mt-2" id="tableItem">' +
                    ...
                    '</tr>' +
                    '</thead>' +
                    '<tbody id="item'+id_perbaikan+'">' +
                    '</tbody>' +
                '</table>';
            '</div>';
            $.get('/perbaikan/item-perbaikan/'+id_perbaikan, function(data) {
                $.each(data, function(i, item) {
                    ...
                    '</tr>';
                    $('#item'+id_perbaikan).append(tr_row);
                });
    ...
    $('body').on('click', '.btn-validasi', function() {
        ...
        $('#modalValidasi').find('#id_perbaikan').val(id)
